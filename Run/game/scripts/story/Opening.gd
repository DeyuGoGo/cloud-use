	...
	return [
		{
			...
			"beats": [
				...
				{"say": "手機在口袋震了幾下。你停下來，點開——家族群組的早安圖、公司群組在喬明天的會、一個三年沒人講話的大學群組。99+。你滑到底，最後一則 @ 的是別人。"},
		...
		},
		{
			...
			"beats": [
				...
				{"say": "基隆河堤，晚上，風很大，路燈隔超遠。一路上沒遇到半個人。"},
				{"say": "工程師的毛病改不掉，手錶還是記了距離、配速。跑完你站在原地喘，把那幾個數字滑了一遍，截了張圖，停在「分享」那一格——按掉，鎖屏，塞回口袋。"},
		...
		},
		{
			...
			"beats": [
				...
				{"say": "她從你左邊上來，幾步就到了你前面，越跑越遠，背影縮成一個點。你加速了三步，喘了，又慢回原本的速度。看她那盞頭燈晃進黑裡。她沒回頭。"},
			],
		},
		{
